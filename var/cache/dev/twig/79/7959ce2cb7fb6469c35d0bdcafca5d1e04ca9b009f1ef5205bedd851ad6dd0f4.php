...
class __TwigTemplate_a4e3f281db77aafafed1d24d72482f80f643be3816dc20b0324f6a5f8f8f0ba1 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  134 => 37,  129 => 25,  121 => 20,  116 => 17,  108 => 14,  105 => 13,  103 => 12,  100 => 11,  94 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
<section class=\"col-md-4 mx-auto mt-5\">
    <form method=\"post\">
        {% if error %}
    ...
    <h1 class=\"text-center mt-2\">Connexion</h1>
        <label for=\"inputEmail\">Email</label>
        <input type=\"email\" value=\"{{ last_username }}\" placeholder=\"Entrez votre email\" name=\"email\" id=\"inputEmail\" class=\"form-control\" autocomplete=\"email\" required autofocus>
        <label for=\"inputPassword\">Mot de passe</label>
        <input type=\"password\" name=\"password\" placeholder=\"Entrez votre mot de passe\" id=\"inputPassword\" class=\"form-control\" autocomplete=\"current-password\" required>
...
{% endblock %}
", "security/login.html.twig", "C:\\wamp64\\www\\my_fisrt_project\\templates\\security\\login.html.twig");
    }
}
